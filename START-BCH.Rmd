...
```{r}
#LCA indcators: report_dis report_race report_sex counselors_fte psych_fte law_fte
#Auxiliary variables: lunch_program read_test math_test
...
m_step2  <- mplusObject(
  ...
  VARIABLE = 
 "usevar = BCHW1-BCHW3 math_irt female;
  missing are all (999); 
  classes = c(3); 
