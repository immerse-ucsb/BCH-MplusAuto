...
gt() %>% 
tab_header(title = md("**LCA Indicators & Auxiliary Variables: Harassment & School Staff Example**"), subtitle = md("&nbsp;")) %>%
...
bch_ex2_data <- read_csv(here("", ".csv"))
